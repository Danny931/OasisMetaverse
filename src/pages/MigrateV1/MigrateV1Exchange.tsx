...
import { Currency, CurrencyAmount, Fraction, JSBI, Percent, Token, TokenAmount, WETH } from 'oasiswap-sdk'
    ...
    <BodyWrapper style={{ padding: 24 }}>
      <AutoColumn gap="16px">
        ...
        {!account ? (
          ...
          <>
            <TYPE.body my={9} style={{ fontWeight: 400 }}>
              Because Uniswap V2 uses WBNB under the hood, your Uniswap V1 WBNB/BNB liquidity cannot be migrated. You
